        ...
        <div className="shop-container">
            ...
            <div className="content-container">
                ...
                <div className="order-details-section">
                    {selectedOrder ? <OrderView order_id={selectedOrder} status={orders.filter(o => o.order_id == selectedOrder)[0].status } comment={orders.filter(o => o.order_id == selectedOrder)[0].comment} addings={orders.filter(o => o.order_id == selectedOrder)[0].addings} done={handleSendClicked}/> : <p>Please select an order.</p>}
                </div>
                <div className="chat-section">
                    {selectedOrder ? <Chat order_id={selectedOrder} takeaway={orders.filter(o => o.order_id == selectedOrder)[0].IstakeAway != null} /> : <p>Please select an order.</p>}
                </div>
            </div>
        </div>
    );
